package com.northbound.inicializator;

import org.codehaus.jettison.json.JSONArray;
import org.codehaus.jettison.json.JSONException;
import org.codehaus.jettison.json.JSONObject;

import com.northbound.northboundconf.RestInterface;
...
public class FlowInicializer {
	...
	// Data in common
		...
		// OF13|1 - First Switch -----------------------------------------------------------------------------
			...
			// Port 1 listening: Variables between flows		
				...
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:P1:arpFlowInsert", arpData);
			...
			// Port 2 listening: Variables between flows		
				...
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:P2:arpFlowInsert", arpData);
			...
			// Port 3 listening: Variables between flows		
				...
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:P3:arpFlowInsert", arpData);
		...
		// OF13|2 - Second Switch -----------------------------------------------------------------------------
			...
			// Port 1 listening: Variables between flows		
				...
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S2:P1:arpFlowInsert", arpData);
			...
			// Port 2 listening: Variables between flows		
				...
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S2:P2:arpFlowInsert", arpData);
			...
			// Port 4 listening: Variables between flows		
				...
				arpData.put("actions", accion.put("OUTPUT=1,2,3"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S2:P4:arpFlowInsert", arpData);
				arpData.put("actions", accion.remove("OUTPUT=1,2,3"));
		...
		// OF13|3 - Third Switch -----------------------------------------------------------------------------
			...
			// Port 1 listening: Variables between flows		
				...
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:03", "S3:P1:arpFlowInsert", arpData);
	...
	// Data in common
		...
		// H1 to H2: Variables between flows
				...
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:H1-H2:InicialFlowInsert", postData);
			...
			// H1 to H3: Variables between flows
				...
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:H1-H3:InicialFlowInsert", postData);
			...
			// H1 to H4: Variables between flows
				...
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:H1-H4:InicialFlowInsert", postData);
		...
		// From H2 to H1: Variables between flows
				...
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:H2-H1:InicialFlowInsert", postData);
			...
			// From H2 to H3: Variables between flows
				...
				postData.put("actions", accio.put("OUTPUT=3,5"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:H2-H3:InicialFlowInsert", postData);
			...
			// From H2 to H4: Variables between flows
				...
				postData.put("nwDst", "10.0.0.4");
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:H2-H4:InicialFlowInsert", postData);
				postData.put("actions", accio.remove("OUTPUT=3,5"));
		...
		// From H3 to H1: Variables between flows
				...
				postData.put("actions", accio.put("OUTPUT=1"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:H3-H1:InicialFlowInsert", postData);
				postData.put("actions", accio.remove("OUTPUT=1"));
			...
			// From H3 to H2: Variables between flows
				...
				postData.put("actions", accio.put("OUTPUT=2"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:H3-H2:InicialFlowInsert", postData);
				postData.put("actions", accio.remove("OUTPUT=2"));
		...
		// From H4 to H1: Variables between flows
				...
				postData.put("actions", accio.put("OUTPUT=1"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:H4-H1:InicialFlowInsert", postData);
				postData.put("actions", accio.remove("OUTPUT=1"));
			...
			// From H4 to H2: Variables between flows
				...
				postData.put("actions", accio.put("OUTPUT=2"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:01", "S1:H4-H2:InicialFlowInsert", postData);
				postData.put("actions", accio.remove("OUTPUT=2"));
	...
	// OF13|2 - Second Switch -----------------------------------------------------------------------------
		...
		// H1 to H3: Variables between flows
				...
				postData.put("actions", accio.put("OUTPUT=1"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S2:H1-H3:InicialFlowInsert", postData);
				postData.put("actions", accio.remove("OUTPUT=1"));
			...
			// H1 to H4: Variables between flows
				...
				postData.put("actions", accio.put("OUTPUT=2"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S2:H1-H4:InicialFlowInsert", postData);
				postData.put("actions", accio.remove("OUTPUT=2"));
		...
		// H2 to H3: Variables between flows
				...
				postData.put("actions", accio.put("OUTPUT=1"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S2:H2-H3:InicialFlowInsert", postData);
				postData.put("actions", accio.remove("OUTPUT=1"));
			...
			// H2 to H4: Variables between flows
				...
				postData.put("actions", accio.put("OUTPUT=2"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S2:H2-H4:InicialFlowInsert", postData);
				postData.put("actions", accio.remove("OUTPUT=2"));
		...
		// H3 to H1: Variables between flows
				...
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S2:H3-H1:InicialFlowInsert", postData);
			...
			// H3 to H2: Variables between flows
				...
				postData.put("nwDst", "10.0.0.2");
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S1:H3-H2:InicialFlowInsert", postData);
			...
			// H3 to H4: Variables between flows
				...
				postData.put("actions", accio.put("OUTPUT=2"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S2:H3-H4:InicialFlowInsert", postData);
				postData.put("actions", accio.remove("OUTPUT=2"));
		...
		// H4 to H1: Variables between flows
				...
				postData.put("actions", accio.put("OUTPUT=3"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S2:H4-H1:InicialFlowInsert", postData);
			...
			// H4 to H2: Variables between flows
				...
				postData.put("nwDst", "10.0.0.2");
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S2:H4-H2:InicialFlowInsert", postData);
				postData.put("actions", accio.remove("OUTPUT=3"));
				...
				postData.put("actions", accio.put("OUTPUT=1"));
				// Actual flow install
				RestInterface.installFlow("00:00:00:00:00:00:00:02", "S2:H4-H3:InicialFlowInsert", postData);
